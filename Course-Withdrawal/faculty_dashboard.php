...
<body>
    <div class="header">
        ...
        <div class="header-buttons">
                        ...
                        <?php else: ?>
                            <?php foreach($pendingWithdrawals as $notif): ?>
                                <div class="notification-item unread">
                                    <div class="notification-icon">Request</div>
            ...
            <button onclick="window.print()" class="manage-btn">Print</button>
                            ...
                            <?php foreach($pendingWithdrawals as $request): ?>
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        <button class="approve-btn" onclick="openReviewModal(<?php echo $request['request_id']; ?>, 'approved', '<?php echo addslashes($request['first_name'] . ' ' . $request['last_name']); ?>', '<?php echo addslashes($request['subject_code']); ?>')">Approve</button>
                                        <button class="reject-btn" onclick="openReviewModal(<?php echo $request['request_id']; ?>, 'rejected', '<?php echo addslashes($request['first_name'] . ' ' . $request['last_name']); ?>', '<?php echo addslashes($request['subject_code']); ?>')">Reject</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
