...
function sendEmail($to, $subject, $message) {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('your-email@gmail.com', 'Course Withdrawal System');
        $mail->addAddress($to);
...
// Keep existing notification functions...
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <a href='http://localhost/withdrawal_system/login.php' class='button'>Review Request</a>
            </div>
            <div class='footer'>
